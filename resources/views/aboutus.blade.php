...
@section('content')
    ...
    <section class="pricing-area ptb-100 extra-mb pb-0"
             style="margin-bottom: 100px!important;background: rgba(211,211,211,0.15);padding-bottom: 30px!important;">
        <div class="container">
            <div class="section-title">
<span>
{{--<span>Eagle Internet Pricing</span>--}}
</span>
                <h2>About Eagle Internet</h2>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-services-box1" style="border-color: lightgrey">
                        ...
                        <h3>No Data Caps or Usage Limits</h3>
                        <p>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="single-services-box1" style="border-color: lightgrey">
                        ...
                        <h3>Guaranteed Minimum Speeds</h3>
                        <p>
